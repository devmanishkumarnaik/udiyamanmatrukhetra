...
import { FaUser, FaLock, FaEnvelope, FaPhone, FaCamera, FaChalkboardTeacher, FaUserGraduate } from 'react-icons/fa';
...
const Register = () => {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    if (!userType) {
      setMessage({ type: 'error', text: 'Please select user type (Teacher or Student)' });
      return;
    }
